...
test('test', async ({ page }) => {
    ...
    try {
        ...
        await page.waitForTimeout(delay);
        await page.getByPlaceholder('กรอกคำค้นหา').fill(DocNum);
        await page.waitForTimeout(delay);
        ...
        if (Find) {
            ...
            if (text === expectedText) {
                ...
                const comnamexpath = '//*[@id="oliTransferBchOutTitle"]';
                ...
                await page.waitForTimeout(delay);
                await page.getByRole('textbox', { name: 'กรอกคำค้นหา' }).fill(DocNum);
                await page.waitForTimeout(delay);
                await page.getByRole('textbox', { name: 'กรอกคำค้นหา' }).press('Enter');
                await page.waitForTimeout(3000);
                console.log('\x1b[36m%s\x1b[0m', '[กำลังแก้ไขข้อมูล]');
                await page.locator('#otrTransferBchOutHD0 > td:nth-child(10)').click();
                await page.waitForTimeout(delay);
                ...
                if (elBrCreate && elDocNumber && elDocSta) {
                    ...
                    await page.waitForTimeout(delay);
                    await page.locator('#otrTransferBchOutHD0 > td:nth-child(9) > img').click();
                    await page.waitForTimeout(delay);
                    await page.getByRole('button', { name: 'ยืนยัน' }).click();
